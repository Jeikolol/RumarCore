...
namespace RumarApp.Migrations
{
    ...
    [Migration("20210903004042_add_field_clientid_table_beneficiaries")]
    partial class add_field_clientid_table_beneficiaries
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RumarApp.Models.Beneficiary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RumarApp.Models.RelationshipType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RumarApp.Models.TaxType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RumarApp.Models.Beneficiary", b =>
                {
                    b.HasOne("RumarApp.Models.ClientViewModel", "Client")
                        .WithMany("Beneficiaries")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RumarApp.Models.Loan", null)
                        .WithMany("Beneficiary")
                        .HasForeignKey("LoanId");

                    b.HasOne("RumarApp.Models.RelationshipType", "RelationshipType")
                        .WithMany()
